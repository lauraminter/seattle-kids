...
# read in our data
df = pd.read_csv('./data/dashdata/dash-data-enrollment.csv')
...
def update_graph(xaxis_column_name, yaxis_column_name,
    ...
    fig = px.scatter(x=dff[dff['Indicator Name'] == xaxis_column_name]['Value'],
            ...
            hover_name=dff[dff['Indicator Name'] == yaxis_column_name]['School Name']
            )

    fig.update_traces(customdata=dff[dff['Indicator Name'] == yaxis_column_name]['School Name'])
...
def update_y_timeseries(hoverData, xaxis_column_name, axis_type):
    ...
    dff = df[df['School Name'] == school_name]
...
def update_x_timeseries(hoverData, yaxis_column_name, axis_type):
    dff = df[df['School Name'] == hoverData['points'][0]['customdata']]
